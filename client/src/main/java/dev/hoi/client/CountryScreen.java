...
/** Read-only foreign dossier; every target change clears the preceding private report. */
public final class CountryScreen extends Screen implements SidebarMovement.Screen {
    ...
    CountryScreen(String target) { super(Component.literal("외교")); this.target = target; choosing = target.isEmpty(); }
    CountryScreen(CountryView fixture) { this(fixture.target()); view = fixture; }
    ...
    void update(CountryProtocol.Response packet) {
