...
import java.util.*;
import dev.hoi.client.ResearchLayout.Node;
import dev.hoi.client.TfrResearchLayout.Segment;

/** Only exceptional source cross-links need obstacle routing; normal families retain shared buses. */
