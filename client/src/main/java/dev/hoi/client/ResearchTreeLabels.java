...
/** Places reference captions using the loaded font, without moving technology cards or year guides. */
final class ResearchTreeLabels {
    record Label(String text, int x, int y, int width, int height, boolean year) {}
    ...
    static List<Label> create(ResearchLayout layout, ToIntFunction<String> textWidth, int lineHeight) {
    ...
    private static void place(List<TfrResearchLayout.Label> anchors, boolean year, ToIntFunction<String> textWidth,
        ...
        for (var anchor : anchors) {
            ...
            // Equipment captions may move upward only; they must never turn into labels below their cards.
