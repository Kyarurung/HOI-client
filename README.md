...
상단 메뉴 순서는 국가 정보, 결정, 정보기관, 연구, 무역 & 경제, 건설, 생산, 모병 및 배치, 군수, 장교단입니다. 국가 정보·모병 및 배치는 왼쪽 **40%**, 외교·무역·경제는 **35%**, 연구 슬롯·정보기관 및 나머지 기본 패널은 **30%** 너비입니다. 상세 창과 전체 연구 트리는 별도로 열립니다. 사이드바에서 설정된 이동·점프·내려가기·달리기 키를 사용할 수 있고, 상세 창·검색·전체 트리·포커스 이탈 시 이동 입력을 해제합니다.

연구 슬롯은 한 화면에 최대 6개를 표시하고 남는 세로 공간은 상단 연구 배너에 배분하며, 서버에서 제공하는 추가 슬롯은 다음 페이지에서 확인합니다. 내부 8개 연구 분야를 유지하며 화면에는 보병, 지상 & 항공 지원, 기갑, 포, 해군, 해군 지원 장비, 공군, 공학, 산업의 9개 아이콘 탭을 표시합니다. 탭에는 라벨을 붙이지 않고 툴팁과 접근성 이름만 제공합니다. `category/`와 `tabs/`는 같은 원작 UI 아이콘을 사용하며, 선택한 탭의 아래 테두리는 연구 패널에 이어집니다. 기술 상세에도 해당 아이콘 탭을 부착합니다. 모든 이미지는 원본 비율을 유지합니다. 상단 연구 배너만 영역을 채우도록 중앙 부분을 잘라 표시하고 나머지는 지정 영역 안에 중앙 정렬하며, 탭·사진의 최대 크기는 패널 너비와 독립적으로 제한합니다.
